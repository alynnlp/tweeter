...
function createTweetElement(tweetobject){
  //im going to stick in the tweetobject into the class article
  $("article").append(tweetobject);
...
//   var $img = $('<img>').append('')
//   //p.name
//   var $name = $('p.name').append('')
//   //p.username
//   var $username = $('p.username').append('')
//   //p.tweet-content
//   var $tweet-content = $('p.tweet-content').append('')
//   //p.days
//   var $days = $('p.days').append('')
//
//
//
//   return $tweet;
